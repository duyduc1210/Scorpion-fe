  ...
  return (
    <>
      <footer className="footer1">
            ...
            <div className="footer-contact-us">
              ...
              <p className="footer-description-detail">
                <img
                  ...
                  alt="scorpion hotel location"
                />

                <span> Muine Bay Resort, Thành Phố Phan Thiết, Bình Thuận</span>
              </p>
              <p className="footer-description-detail">
                <img
                  src="./assets/img/phone.svg"
                  className="footer-description-icon"
                  alt="scorpion hotels phone number"
                />
              ...
              <p className="footer-description-detail">
                <img
                  ...
                  className="footer-description-icon"
                  alt="scorpion hotels email"
                />
                <span>support@scorpionhotels.com</span>{" "}
              </p>
            </div>
                ...
                <li className="follow-us-list">
                  <a href="">
                    <img
                      ...
                      alt="scorpion hotels facebook page"
                    />
                  </a>
                </li>
                <li className="follow-us-list">
                  <a href="">
                    <img
                      ...
                      alt="scorpion hotels twitter page"
                    />
                  </a>
                </li>
                <li className="follow-us-list">
                  <a href="">
                    <img
                      ...
                      alt="scorpion hotels instagram page"
                    />
                  </a>
                </li>
              </ul>
        ...
        <center>
          <p>Copyright © 2024 SCORPIO - All rights Reserved.</p>
          <br />
        </center>
      </footer>
    </>
